    ...
    return (
        ...
        <div ref={vantaRef} className='h-screen'>
            ...
            <div className='fixed bottom-4 right-4 z-50'>
                <button
                className='bg-black hover:bg-gray-600 text-white font-bold py-2 px-4 rounded-lg transition-all duration-300'
                onClick={scrolltop}
                >
                <FaArrowUp />
                </button>
        ...
        <div className='bg-zinc-900'>
            ...
            <div className='flex lg:flex-1 flex-col justify-centerskill p-4'>
                ...
                <div className='grid place-content-center'>
                    <Image src={Next} height={100} width={100} alt='Profile pic' className='hover:scale-110 rounded-full lg:w-[70px] lg:h-[70px] object-cover w-[45px] h-[45px] transition mt-4' />
                </div>
                <div className='grid place-content-center'>
                    <Image src={android_logo} height={100} width={100} alt='Profile pic' className='hover:scale-110 rounded-full lg:w-[70px] lg:h-[70px] object-cover w-[45px] h-[45px] transition mt-4' />
                </div>
                <div className='grid place-content-center'>
                    <Image src={react_logo} height={100} width={100} alt='Profile pic' className='hover:scale-110 rounded-full lg:w-[70px] lg:h-[70px] object-cover w-[45px] h-[45px] transition mt-4' />
                </div>
                <div className='grid place-content-center'>
                    <Image src={c} height={100} width={100} alt='Profile pic' className='hover:scale-110 rounded-full lg:w-[70px] lg:h-[70px] object-cover w-[45px] h-[45px] transition mt-4' />
                </div>
                <div className='grid place-content-center'>
                    <Image src={java} height={100} width={100} alt='Profile pic' className='hover:scale-110 rounded-full lg:w-[70px] lg:h-[70px] object-cover w-[45px] h-[45px] transition mt-4' />
                </div>
                <div className='grid place-content-center'>
                    <Image src={Html} height={20} width={20} alt='Profile pic' className='m-2' />
                </div>
                </div>
            </div>
            ...
            <div className='p-4 text-white flex flex-col'>
            <h1 className='text-left font-medium lg:text-[25px]'>ACHIEVEMENTS</h1>
            <div className='card body flex flex-wrap justify-center items-center flex-col lg:flex-row lg:gap-10 gap-5 mt-6 lg:justify-start lg:p-6'>
                <Skill_card image_link={best_project} img_class={'max-h-[140px] max-w-[280px] h-auto w-auto'} heading={'Best Project Award'} paragraph={'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'} />
                <Skill_card image_link={hackathon} img_class={'max-h-[140px] max-w-[280px] h-auto w-auto'} heading={'Hackathon Winner'} paragraph={'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'} />
                <Skill_card image_link={Project_day} img_class={'max-h-[140px] max-w-[280px] h-auto w-auto'} heading={'Project Day Winner'} paragraph={'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'} />
                <Skill_card image_link={technical_event} img_class={'max-h-[140px] max-w-[280px] h-auto w-auto'} heading={'Technical Event Winner'} paragraph={'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'} />
            </div>
            </div>
