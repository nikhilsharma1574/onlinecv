...
return (
    <div>
        <div role="status" data-aos="zoom-in-up" className={`${design} flex space-y-8 justify-start h-full md:space-y-0 md:flex md:items-center scale-95 hover:scale-100 delay-75 transition-transform hover:cursor-pointer`}>
