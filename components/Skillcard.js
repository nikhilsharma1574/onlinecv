...
return (
            <div data-aos="fade-up" class="transition-all delay-75 hover:scale-105 object-contain flex flex-row border p-2 h-fit max-w-[300px] rounded-lg shadow bg-gray-800 border-gray-700">
                ...
                <div class="px-2 pb-3 pt-3">
                    <a href="#">
                        <h5 class="mb-2 lg:text-lg font-bold tracking-tight text-gray-900 dark:text-white">{heading}</h5>
                    </a>
                    <p class="mb-1 text-[8px] lg:text-[12px] font-normal line-clamp-3 text-gray-700 dark:text-gray-400">{paragraph}</p>
